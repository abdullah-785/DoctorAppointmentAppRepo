...
class AllDoctorHospital extends StatefulWidget {
  const AllDoctorHospital(
      ...
      this.type,
      this.doctorSpeicalist});

  final String title;
  final bool isHospital;
  final String? type;
  final String? doctorSpeicalist;
      ...
      body: Column(
        children: [
          ...
          widget.isHospital
              ...
              : !widget.isHospital && widget.doctorSpeicalist != null
                  ? StreamBuilder<QuerySnapshot>(
                      stream: FirebaseFirestore.instance
                          .collection('Doctor')
                          .where("specializeIn",
                              isEqualTo: widget.doctorSpeicalist)
                          .snapshots(),
                      builder: (BuildContext context,
                          AsyncSnapshot<QuerySnapshot> snapshot) {
                        ...
                        final List<DoctorModel> doctor = snapshot.data!.docs
